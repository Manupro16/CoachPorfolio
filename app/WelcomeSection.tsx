...
function WelcomeSection() {
    ...
    return (
        <section className="relative w-full overflow-hidden bg-black/10">
            ...
            >
                {/* Top wave */}
                <Box as="div" className="absolute inset-x-0 top-0 w-full h-[80%]">
                    <svg
                ...
                {/* Bottom wave */}
                <Box as="div" className="absolute inset-x-0 bottom-0 w-full h-[10%]">
                    <svg
                        viewBox="0 0 1440 320"
                        className="w-full h-full fill-current text-primaryDark opacity-30"
                        preserveAspectRatio="none"
            ...
            <Grid as="div" columns={{initial: "1", md: "1fr 1fr"}} rows="auto" gap={{ initial: "6", md: "10" }} className="relative w-full min-h-screen">
                ...
                <Flex
                    ...
                    direction="column"
                    align="center"
                    className="text-center p-4 lg:col-span-2"
                >
                    <Heading
                        as="h2"
                        size="8"
